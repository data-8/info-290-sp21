      ...
      'cases': [
        {
          ...
          True
          >>> "Cause of Death (Full Description)" not in cleaned_causes.labels # It looks like you to do the third step in dropping the abbreviations and renaming the description
          True
