      ...
      'cases': [
        {
          ...
          >>> t.labels == ('geo', 'population_total', 'children_per_woman_total_fertility', 'child_mortality_under_5_per_1000_born') # Incorrect labels for columns
          True
          """,
          'hidden': False,
          'locked': False
        },
        {
          'code': r"""
          >>> t = stats_for_year(1990)
          >>> t.num_rows # Incorrect number of rows
          50
          """,
          'hidden': False,
          'locked': False
