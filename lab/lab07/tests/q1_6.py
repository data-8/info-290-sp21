      ...
      'cases': [
        {
          ...
          >>> abs(11 - (np.mean(ok_test_array) - mean_based_estimator(ok_test_array))) < 4 # Make sure your estimator is subtracting a reasonable value from the mean observation
          True
